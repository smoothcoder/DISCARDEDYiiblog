...
class User extends CActiveRecord
{
	...
	const STATUS_PREMIUM=3; // NEW
	const STATUS_GUEST=4;

	const BANNED_NO=0;
	const BANNED_YES=1;

	const NEWSLETTER_NO=0;
	const NEWSLETTER_YES=1;
	...
	*/
	public function rules()
	{
		...
		array('avatar','file','types'=>'gif, png, jpg, jpeg','maxSize'=>1242880, 'allowEmpty'=>true),
		...
		array('newsletter','in','range'=>array(0,1)), // no-yes
	...
	*/
	public function relations()
	{
		...
		return array(
		'posts'=>array(self::HAS_MANY,'Post','authorId','order'=>'posts.createTime'), // MFM 1.1 migration ??
	...
	*/
	public function attributeLabels()
	{
		...
		'password_repeat'=>Yii::t('lan','Verify'),
	...
	*/
	...
	{
		return array(
		self::NEWSLETTER_NO=>Yii::t('lan','No'),
		self::NEWSLETTER_YES=>Yii::t('lan','Yes'),
		);
	}
	/**
	* @return string the status display for the current user
	*/
	public function getNewsletterText()
	{
		...
		return $options[$this->newsletter];
	}
...
/**
    ...
    protected function beforeValidate()
    {
        if($this->isNewRecord)
        {
            $this->created=$this->lastlogin=time();
        }
