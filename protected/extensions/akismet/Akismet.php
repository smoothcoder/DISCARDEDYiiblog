 ...
 *     // $comment->authorIP=$this->comment['user_ip']
 *  </code>
 *
...
// print_r($this->blogURL);echo "#<br/>";
// print_r($this->wordPressAPIKey);echo "##<br/>";
// print_r($this->akismetServer);echo "###<br/>";
